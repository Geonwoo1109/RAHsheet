...
#### 25.10.14
-> 현재일을 1일차로 보고, 28일차 까지만 신청 가능하도록 변경

#### 25.11.23
-> RAH시간도 이제 자동스로 신청되게끔 변경

#### 25.12.4.
```
input:
12/7(일) 10-13 방음
12/7(일) 14-16 마루 신청합니다
...
output:
{
    ...
    "no": {
        ...
        "마루": [],        // 나머지 하나 어디?
        "방음": [
            "12/7(일) 10-13 방음연습실 -> P5:P7 (칸타빌레,칸타빌레,)"
        ],
        "매트": []
    },
    "미확인": []
...
```
-> 반복문 내부에서 i를 다른 함수에서도 사용하다보니 i값이 변경되는 문제 발생. 그래서 i -> order로 바꿔주니 해결됨 
